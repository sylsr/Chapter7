...
public class PP7_4 
{
	static PP7_4 master = new PP7_4();
	public void asteriskPrintOut(int asteriskNum)
	{
		int remainder= asteriskNum%5;
		int prePrintOutNum=asteriskNum-remainder;
		int printOutNum=prePrintOutNum/5;
		for(int current=0; current<printOutNum; current++)
		{
			System.out.print("*");
		}
		System.out.println("");
	...
	{
		int[] frequencyArray =new int[1000];
